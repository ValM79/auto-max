    ...
    <div className="min-h-screen bg-[#f4f5f6]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Used Cars For Sale</h1>
        ...
        {/* Banner */}
        <div className="mb-6 rounded-xl overflow-hidden h-32 bg-blue-600 flex items-center justify-between px-8">
          <div className="text-white">
            <p className="text-xs font-semibold uppercase tracking-wider mb-1">Great Value</p>
            <p className="text-3xl font-extrabold leading-tight">USED CARS<br />SPECIAL</p>
          </div>
          <img src="https://images.unsplash.com/photo-1578915036782-aa8b4b42a06d?w=300&q=80" alt="Banner" className="h-full object-cover rounded-lg opacity-80" />
        </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-foreground font-medium"><span className="font-bold">{filtered.length}</span> used cars in Ireland</p>
