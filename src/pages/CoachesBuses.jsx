    ...
    <div className="min-h-screen bg-[#f4f5f6]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Coaches & Buses in Ireland</h1>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-foreground font-medium">
                <span className="font-bold">480</span> ads for Coaches & Buses in Ireland
              </p>
                  ...
                  <div className={viewMode === 'grid' ? 'flex flex-col' : 'flex flex-col sm:flex-row'}>
                    ...
                    <div className="flex-1 p-4 flex flex-col justify-between">
                      <div>
                        ...
                        {item.year && (
                          <p className="text-xs text-muted-foreground">{item.year} · {item.fuel} · {item.mileage}</p>
                        )}
                        {item.description && (
